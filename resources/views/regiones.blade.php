    ...
    @foreach( $regiones as $region )
        <li class="col-md-6 list-group-item list-group-item-action d-flex justify-content-between">
            ...
            <div class="col text-end btn-group">
                <a href="/regiones/edit/{{$region->idRegion}}" class="btn btn-outline-secondary me-1">
                    <i class="bi bi-pencil-square"></i>
                    Modificar
                </a>
                <a href="/region/delete/{{$region->idRegion}}/{{$region->regNombre}}" class="btn btn-outline-secondary me-1">
